package SetGetNesneYönelimliExample;

public class Student 
{
	private int rollNumber; // Kayıt liste numarası 
    private String name; 	// Öğrencinin adı  
    private int marks1;		// Birinci sınav notu
    private int marks2;		// İkinci sınav notu
    private int marks3; 	// Üçüncü sınav notu
    ...
    public double getAverage() { 		/*	Öğrencinin sınavlarının ortalaması  */
